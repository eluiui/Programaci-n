 ...
 * @author a22diegopc
 */
public class LInvertida extends Ficha {

    public LInvertida(Juego juego, Color color) {
        super(juego);
...
//luego rota la ficha utilizando los metodos rotacion dependiendo de la posicion
    ...
    public boolean rotar() {
        switch (posicion) {
            case 0 -> {
                if (cuadrado1.x < juego.XMAX - Juego.LADOCUADRADO && allowRotar0()) {
                    rotacion0();
                }
            ...
            case 2 -> {
                if (cuadrado1.x > 0 && allowRotar2()) {//bad smell
                    rotacion2();
                }
            }
            case 3 -> {
